module.exports = {
  ...
  coveragePathIgnorePatterns: [
    ...
    '/src/components/ImageLink',
    '/src/components/admindashboard',
    '/src/components/sideNavBar',
    '/src/components/loginView',
    '/src/views',
    '/src/components/Logout',
    '/src/components/carouselView',
    '/src/components/homepage',
    '/src/components/adminLogin/adminLoginView.jsx',
    '/src/components/adminLogin/index.jsx',
    '/src/components/registrationPage',
    '/src/components/signupView',
